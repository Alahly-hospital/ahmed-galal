...
const Main = () => {
  ...
  return (
    <Container
      ...
      style={{ position: "relative", marginBottom: "150px" }}
    >
      <Row>
        ...
        <div className="col-12 col-md-6 right-main-section">
          ...
          <ul>
            ...
            >
              {" "}
              <Button className="   m-auto mt-4 reserve-btn mb-4">احجز الان</Button>
            </Link>
          </ul>
        </div>
      </Row>
      <div className="floating-box mb-3">
        <p className="location">
          {" "}
          <MdLocationOn />
          المركز : ٢٩ شارع جلال حماد ناصية شارع جمال عبد الناصر <br /> اول شارع
          بعد ميدان جيهان ميامى الاسكندرية
        </p>
      </div>
