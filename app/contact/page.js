      ...
      <div className="container">
        ...
        <div className="row d-flex align-content-center justify-content-around  m-4">
          <div className="col-md-3 text-center contact-bg rounded p-3 m-2 shadow">
            ...
            <h5>
              <a
                href="https://www.facebook.com/gitclinic/?locale=ar_AR"
          ...
          <div className="col-md-3 text-center contact-bg rounded p-3 m-2 shadow">
            ...
            <h5>
              المركز : ٢٩ شارع جلال حماد ناصية شارع جمال عبد الناصر اول شارع بعد
              ميدان جيهان ميامى الاسكندرية
            </h5>
          </div>
        </div>
        ...
        <div>
          <h1
            className="text-center pt-4 secondary-color fw-bold mt-4"
            style={{ fontSize: "3rem" }}
          >
            مركز الدكتور
          </h1>
