  ...
  return (
    ...
    <Row>
        <div className='col-12 col-md-6 left-main-section'>
          <Slider {...settings}>
            <img className="slider-image" src={MainImage.src} height={75} className='w-100' alt="" />
            <img className="slider-image"  src={MainImage2.src}height={75}className='w-100'  alt="" />
            <img className="slider-image"  src={MainImage3.src}height={75}className='w-100'   alt="" />
          </Slider>
        </div>
